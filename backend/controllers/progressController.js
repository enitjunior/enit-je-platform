...
console.log('=== progressController.js: TOP ===');
console.log('Progress model:', typeof Progress);
console.log('Training model:', typeof Training);
...
console.log('=== progressController.js: BOTTOM ===');
